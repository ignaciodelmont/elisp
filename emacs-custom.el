(custom-set-variables
 ...
 '(package-selected-packages
   '(editorconfig copilot quelpa-use-package quelpa python-mode company-lsp lsp-ui poetry flycheck fly-check lsp-pyright markdown-mode all-the-icons-install-fonts all-the-icons-fonts doom-themes doom-modeline all-the-icons use-package))
